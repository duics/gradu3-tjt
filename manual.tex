...
\opt{copyright}, \opt{logo}, \opt{newtitle}, \opt{nocopyright},
\opt{nonumbib}, \opt{nottoc}, \opt{numbib}, \opt{oldtitle},
\opt{palatino}, \opt{shortthesis}, \opt{surnamefirst}, and \opt{toc}.
Similarly, the commands \cmd{copyrightowner}, \cmd{copyrightyear},
\cmd{license}, and \cmd{setauthor} have been removed.
