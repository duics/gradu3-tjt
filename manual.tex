...
It may also be used elsewhere if it conforms to their requirements.
\end{abstract}
...
\item[yliopisto] the university to which this thesis will be submitted (defaults to ``Jyväskylän yliopisto'' in Finnish and ``University of Jyväskylä'' in English)
...
\item[aine] the formal subject (major or minor) whose thesis this is
  (defaults to ``Tietotekniikan'' in Finish and ``in Information
