...
alaotsikko (subtitle) ja julkaisija (publisher).  Numerotietoja
lukuunottamatta kenttien sisällöt laitetaan aaltosulkeisiin.
...
\parencite[luvut 5.1--5.2]{biblatex-chicago-manual}.
...
Lähdeluettelon ja lähdeviitteiden suomen kielen tuki ei ole
toistaiseksi aivan virheetöntä.  Viitattaessa useaman tekijän
lähteeseen tulee lähdeviitteeseen merkintä ''et~al.'', kun vakiintunut
suomalainen ilmaisu on ''ym.''.  Lisäksi jos lähdetietokantaan
kirjoittaa urldate-päiväyksen, tulee se lähdeluetteloon
virheellisessä muodossa.  Kumpikin vika korjaantunee aikanaan.
