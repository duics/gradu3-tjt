...
\item Option \opt{logo} has been removed and its functionality is not
  supported.
\item Options \opt{toc} and \opt{nottoc} have been removed.
\item Option \opt{altlinespread} has been removed and its
  functionality is not supported.
\item Option \opt{shortthesis} has been removed and its functionality
  is not supported.
\end{itemize}
